...
const file_helloworld_proto_rawDesc = "" +
	...
	"\aGreeter\x12>\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x002L\n" +
	"\vDataHandler\x12=\n" +
	"\aSendACK\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x00B\"Z com/arunhiremath/go-grpc-test/pbb\x06proto3"
...
var file_helloworld_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.DataHandler.SendACK:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	1, // 3: helloworld.DataHandler.SendACK:output_type -> helloworld.HelloReply

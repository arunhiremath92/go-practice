...
const (
	DataHandler_SendACK_FullMethodName = "/helloworld.DataHandler/SendACK"
)
...
type DataHandlerClient interface {
	SendACK(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *dataHandlerClient) SendACK(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, DataHandler_SendACK_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataHandlerServer interface {
	SendACK(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedDataHandlerServer) SendACK(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _DataHandler_SendACK_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataHandlerServer).SendACK(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataHandler_SendACK_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataHandlerServer).SendACK(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DataHandler_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "helloworld.DataHandler",
	HandlerType: (*DataHandlerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendACK",
			Handler:    _DataHandler_SendACK_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "helloworld.proto",
